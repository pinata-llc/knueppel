...
exports.compileQuery = exports.buildQuery = exports.Expression = exports.QueryBuilder = exports.Query = void 0;
...
function compileQuery(jsonAst, resolve) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, buildQuery(jsonAst, resolve)];
                case 1:
                    query = _a.sent();
                    return [2 /*return*/, query.compile()];
            }
        });
    });
}
