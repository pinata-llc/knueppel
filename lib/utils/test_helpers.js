...
function getMockResolver(identifierConfig) {
    var _this = this;
    return function (name) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, Promise.resolve(identifierConfig[name])];
    }); }); };
}
